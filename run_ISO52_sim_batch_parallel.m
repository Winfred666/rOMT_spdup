% Run ISO_52 simulation pairs (9_10 to 15_16) in parallel.
% Each config is a single-interval run: first_time == last_time.

config_names = {
    'ours_ISO52_sim_9_10'
    'ours_ISO52_sim_10_11'
    'ours_ISO52_sim_11_12'
    'ours_ISO52_sim_12_13'
    'ours_ISO52_sim_13_14'
    'ours_ISO52_sim_14_15'
    'ours_ISO52_sim_15_16'
};
...
if nJobs <= 1
    ...
    fprintf('Single ISO52 simulation config completed.\n');
    return;
end
...
fprintf('All ISO52 simulation configs completed.\n');
