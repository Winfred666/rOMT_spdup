...
glacfg.sp_thresh = cfg.sp_thresh; %0.2;%1;%0; % percentage threshold for max(data) to be considered GLAD start point.

glacfg.nEulStep = cfg.integral_euler_step; %number of Eulerian steps to be taken per dt, higher for accurate.
glacfg.mdt = cfg.dt / glacfg.nEulStep * cfg.GLAD_timestep_factor;%3;%5;%10;

glacfg.sl_tol = cfg.sl_tol; %threshold for minimum Euclidean length between initial and final streamline points                
